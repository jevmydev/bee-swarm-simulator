...
export const LinkAd = ({ title, imageUrl, textClass }) => {
    return (
        <Link className={`${textClass} relative overflow-hidden rounded-lg flex justify-center p-16 w-full transition-transform hover:scale-[1.01]`} href="/bond" title={title}>
